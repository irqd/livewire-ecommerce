<div class="container">
    <div class="row justify-content-around">
        ...
        <div class="col-md-8 col-lg-5 p-4">
            <form class="shadow-sm rounded p-3 p-md-5" wire:submit.prevent="register">
                @csrf
                ...
                <div class="form-outline mb-4 mt-4">
                    ...
                    wire:model.debounce.500ms="username" autocomplete="off"/>
                ...
                <div class="form-outline mb-4 mt-4">
                    ...
                    wire:model.debounce.500ms="email" autocomplete="off"/>
                    @error('email') 
                        <small class="text-danger">{{ $message }}</small> 
                    @enderror
                </div>
                ...
                <div class="form-outline mb-4">
                    ...
                    wire:model.debounce.500ms="confirm_password"/>
